...
class SACTrainer(TorchTrainer, LossFunction):
    ...
    def train_from_torch(self, batch):
        ...
        if self.use_automatic_entropy_tuning:
            ...
            update_network(self.policy, self.alpha_optimizer, 0, self.scaler)
        ...
        update_network(self.qf1, self.qf1_optimizer, 0, self.scaler)

        self.scaler.scale(losses.qf2_loss).backward()
        update_network(self.qf2, self.qf2_optimizer, 0, self.scaler)
