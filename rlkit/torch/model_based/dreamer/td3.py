...
class TD3Trainer(TorchTrainer):
    ...
    def train_from_torch(self, batch):
        ...
        target_q1_values = self.target_qf1(
            torch.cat((next_obs, noisy_next_actions), dim=1)
        )
        ...
        if self._n_train_steps_total % self.policy_and_target_update_period == 0:
            ...
            q_output = self.qf1(torch.cat((obs, policy_actions), dim=1))
        ...
        self.eval_statistics["Rewards in Batch"] = rewards.mean().item()
