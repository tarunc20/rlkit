...
from mopa_rl.config.default_configs import LIFT_CONFIG, ASSEMBLY_OBSTACLE_CONFIG
...
class MoPAMPEnv():
    ...
    def __init__(
        ...
        self.teleport_instead_of_mp = True
    ...
    def reset(self):
        ...
        if not self.plan_to_learned_goals and not self.planner_only_actions and not self.no_mprl:
